        ...
        <div className='hero-bg relative'>
            ...
            <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
                ...
                <input 
                    ...
                    />
                    <button className="bg-red-600 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py rounded flex justify-center items-center">
                        Get Started
            ...
            <div className="py-10 bg-black text-white">
                <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
                    ...
                    <div className='flex-1 relative'>
                        ...
                        <video 
                            className="absolute top-1/2 -translate-x-1/2 -translate-y-1/2 h-1/2 z-0"
                            playsInline
                            autoPlay={true}
                            muted
                            loop
            ...
            <div className="py-10 bg-black text-white">
                <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
                    ...
                    <div className='flex-1 relative overflow-hidden'>
                        ...
                        <video 
                            className="absolute top-2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-1/2 z-10
                            max-w-[63%] 
                            "
                            playsInline
                            autoPlay={true}
            ...
            {/* 4th section */}
            <div className="py-10 bg-black text-white">
                <div className="flex max-w-6xl m-auto items-center justify-center flex-col-reverse md:flex-row
                    px-4 md:px-2
                ">
                    {/* left */}
                    <div className="flex-1 relative">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <p className="text-lg md:text-xl">
                            Send kids on adventures with their favoutite characters in a space made just for them-free
